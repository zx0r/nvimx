...
```shell
# ABOUT:
#  nvimx is a transparent profile manager for Neovim.
#  It imposes zero restrictions on native Neovim functionality.
#  Profile management is implemented as a seamless overlay: configs,
#  plugins, LSPs, DAPs, and CLI flags work exactly as if you called `nvim` directly.
#
# Usage:
#  nvimx [PROFILE] [FILES...][-- ARGS...] # Launch Neovim with a profile
